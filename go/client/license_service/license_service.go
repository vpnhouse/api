...
// GooglePlaySubscriptionPurchasedRequest defines model for GooglePlaySubscriptionPurchasedRequest.
type GooglePlaySubscriptionPurchasedRequest struct {
...
// GooglePlaySubscriptionPurchasedJSONBody defines parameters for GooglePlaySubscriptionPurchased.
type GooglePlaySubscriptionPurchasedJSONBody GooglePlaySubscriptionPurchasedRequest
...
// GooglePlaySubscriptionPurchasedJSONRequestBody defines body for GooglePlaySubscriptionPurchased for application/json ContentType.
type GooglePlaySubscriptionPurchasedJSONRequestBody GooglePlaySubscriptionPurchasedJSONBody
...
type ClientInterface interface {
	...
	// GooglePlaySubscriptionPurchased request with any body
	GooglePlaySubscriptionPurchasedWithBody(ctx context.Context, contentType string, body io.Reader, reqEditors ...RequestEditorFn) (*http.Response, error)

	GooglePlaySubscriptionPurchased(ctx context.Context, body GooglePlaySubscriptionPurchasedJSONRequestBody, reqEditors ...RequestEditorFn) (*http.Response, error)
...
func (c *Client) GooglePlaySubscriptionPurchasedWithBody(ctx context.Context, contentType string, body io.Reader, reqEditors ...RequestEditorFn) (*http.Response, error) {
	req, err := NewGooglePlaySubscriptionPurchasedRequestWithBody(c.Server, contentType, body)
	if err != nil {
		return nil, err
	}
	req = req.WithContext(ctx)
...
func (c *Client) GooglePlaySubscriptionPurchased(ctx context.Context, body GooglePlaySubscriptionPurchasedJSONRequestBody, reqEditors ...RequestEditorFn) (*http.Response, error) {
	req, err := NewGooglePlaySubscriptionPurchasedRequest(c.Server, body)
	if err != nil {
		return nil, err
	}
	req = req.WithContext(ctx)
...
// NewGooglePlaySubscriptionPurchasedRequest calls the generic GooglePlaySubscriptionPurchased builder with application/json body
func NewGooglePlaySubscriptionPurchasedRequest(server string, body GooglePlaySubscriptionPurchasedJSONRequestBody) (*http.Request, error) {
	var bodyReader io.Reader
	buf, err := json.Marshal(body)
	if err != nil {
		return nil, err
	...
	bodyReader = bytes.NewReader(buf)
	return NewGooglePlaySubscriptionPurchasedRequestWithBody(server, "application/json", bodyReader)
}

// NewGooglePlaySubscriptionPurchasedRequestWithBody generates requests for GooglePlaySubscriptionPurchased with any type of body
func NewGooglePlaySubscriptionPurchasedRequestWithBody(server string, contentType string, body io.Reader) (*http.Request, error) {
	var err error
	...
	operationPath := fmt.Sprintf("/api/license-service/google-play/subscription-purchased")
	if operationPath[0] == '/' {
		operationPath = "." + operationPath
	}
...
type ClientWithResponsesInterface interface {
	...
	// GooglePlaySubscriptionPurchased request with any body
	GooglePlaySubscriptionPurchasedWithBodyWithResponse(ctx context.Context, contentType string, body io.Reader, reqEditors ...RequestEditorFn) (*GooglePlaySubscriptionPurchasedResponse, error)

	GooglePlaySubscriptionPurchasedWithResponse(ctx context.Context, body GooglePlaySubscriptionPurchasedJSONRequestBody, reqEditors ...RequestEditorFn) (*GooglePlaySubscriptionPurchasedResponse, error)
...
type GooglePlaySubscriptionPurchasedResponse struct {
	Body         []byte
	HTTPResponse *http.Response
	JSON401      *externalRef1.Error
	JSON403      *externalRef1.Error
...
// Status returns HTTPResponse.Status
func (r GooglePlaySubscriptionPurchasedResponse) Status() string {
	if r.HTTPResponse != nil {
		return r.HTTPResponse.Status
	}
	return http.StatusText(0)
...
// StatusCode returns HTTPResponse.StatusCode
func (r GooglePlaySubscriptionPurchasedResponse) StatusCode() int {
	if r.HTTPResponse != nil {
		return r.HTTPResponse.StatusCode
	}
	return 0
...
// GooglePlaySubscriptionPurchasedWithBodyWithResponse request with arbitrary body returning *GooglePlaySubscriptionPurchasedResponse
func (c *ClientWithResponses) GooglePlaySubscriptionPurchasedWithBodyWithResponse(ctx context.Context, contentType string, body io.Reader, reqEditors ...RequestEditorFn) (*GooglePlaySubscriptionPurchasedResponse, error) {
	rsp, err := c.GooglePlaySubscriptionPurchasedWithBody(ctx, contentType, body, reqEditors...)
	if err != nil {
		return nil, err
	}
	return ParseGooglePlaySubscriptionPurchasedResponse(rsp)
}

func (c *ClientWithResponses) GooglePlaySubscriptionPurchasedWithResponse(ctx context.Context, body GooglePlaySubscriptionPurchasedJSONRequestBody, reqEditors ...RequestEditorFn) (*GooglePlaySubscriptionPurchasedResponse, error) {
	rsp, err := c.GooglePlaySubscriptionPurchased(ctx, body, reqEditors...)
	if err != nil {
		return nil, err
	}
	return ParseGooglePlaySubscriptionPurchasedResponse(rsp)
...
// ParseGooglePlaySubscriptionPurchasedResponse parses an HTTP response from a GooglePlaySubscriptionPurchasedWithResponse call
func ParseGooglePlaySubscriptionPurchasedResponse(rsp *http.Response) (*GooglePlaySubscriptionPurchasedResponse, error) {
	bodyBytes, err := ioutil.ReadAll(rsp.Body)
	defer func() { _ = rsp.Body.Close() }()
	if err != nil {
		return nil, err
	...
	response := &GooglePlaySubscriptionPurchasedResponse{
		Body:         bodyBytes,
		HTTPResponse: rsp,
	}
