...
func NewSubmitUserRequestRequestWithBody(server string, params *SubmitUserRequestParams, contentType string, body io.Reader) (*http.Request, error) {
	...
	operationPath := fmt.Sprintf("/api/client/support/request")
	if operationPath[0] == '/' {
...
func (r SubmitUserRequestResponse) Status() string {
...
func (r SubmitUserRequestResponse) StatusCode() int {
	if r.HTTPResponse != nil {
...
func (c *ClientWithResponses) SubmitUserRequestWithBodyWithResponse(ctx context.Context, params *SubmitUserRequestParams, contentType string, body io.Reader, reqEditors ...RequestEditorFn) (*SubmitUserRequestResponse, error) {
	...
	return ParseSubmitUserRequestResponse(rsp)
}

// ParseSubmitUserRequestResponse parses an HTTP response from a SubmitUserRequestWithResponse call
func ParseSubmitUserRequestResponse(rsp *http.Response) (*SubmitUserRequestResponse, error) {
	...
	response := &SubmitUserRequestResponse{
		Body:         bodyBytes,
		HTTPResponse: rsp,
	}
