...
type ServerInterface interface {
	...
	// (POST /api/client/google-play/subscription-purchased)
...
func HandlerWithOptions(si ServerInterface, options ChiServerOptions) http.Handler {
	...
	r.Group(func(r chi.Router) {
		r.Post(options.BaseURL+"/api/client/google-play/subscription-purchased", wrapper.GooglePlaySubscriptionPurchased)
	})
	r.Group(func(r chi.Router) {
