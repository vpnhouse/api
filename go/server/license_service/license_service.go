...
type ServerInterface interface {
	...
	// Handle google play subscription purchased
	// (POST /api/license-service/google-play/subscription-purchased)
	GooglePlaySubscriptionPurchased(w http.ResponseWriter, r *http.Request)
	// List licenses
...
// GooglePlaySubscriptionPurchased operation middleware
func (siw *ServerInterfaceWrapper) GooglePlaySubscriptionPurchased(w http.ResponseWriter, r *http.Request) {
	ctx := r.Context()
	...
	var handler = func(w http.ResponseWriter, r *http.Request) {
		siw.Handler.GooglePlaySubscriptionPurchased(w, r)
	}
...
func HandlerWithOptions(si ServerInterface, options ChiServerOptions) http.Handler {
	...
	r.Group(func(r chi.Router) {
		r.Post(options.BaseURL+"/api/license-service/google-play/subscription-purchased", wrapper.GooglePlaySubscriptionPurchased)
	})
	r.Group(func(r chi.Router) {
